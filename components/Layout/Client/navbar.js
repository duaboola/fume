...
import accontIcon from './../../../public/images/accontIcon.png'
  ...
  return (
    <>
      ...
      >
        ...
        <hr /> */}
        <div className={`row mx-auto ${c.bottom_bar}`}>
        <div className={`col-3 ${c.brand}`}>
              <Link href="/">
                  <img
                    src={`..${logo.src}`}
                    alt={std.name}
          ...
          <div className={`col-6 m-0 ${c.nav_link}`}>
            <ul className={`w-100 justify-content-center ${c.ul}`}>
          ...
          <div className={`col-3 d-flex align-items-center justify-content-end ${c.track}`}>
            {
              session ? (
                <span
